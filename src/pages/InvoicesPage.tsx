    ...
    <div className="space-y-5">
      <section className="grid gap-3 md:grid-cols-3">
        <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-3xl font-extrabold text-zinc-950">{invoices.length}</p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
            ...
            <tbody className="divide-y divide-zinc-100">
              {invoices.map((invoice) => (
                <tr key={invoice.id}>
                  ...
                  <td className="px-4 py-3 font-bold">{invoice.customerName ?? "بيع مباشر"}</td>
          ...
          <div className="space-y-5">
            <div className="grid gap-3 md:grid-cols-4">
              <div className="rounded-lg bg-zinc-50 p-4">
                ...
                <p className="mt-1 font-extrabold text-zinc-950">{selectedInvoice.customerName ?? "بيع مباشر"}</p>
              </div>
              <div className="rounded-lg bg-zinc-50 p-4">
