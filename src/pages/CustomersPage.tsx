      ...
      <section className="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
        <div className="flex flex-col gap-3 border-b border-zinc-100 p-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm font-normal text-zinc-500">إدارة العملاء والديون محليًا داخل الواجهة</p>
          </div>
          ...
          <div className="space-y-5">
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg bg-zinc-50 p-4">
                ...
                <p className="font-features-normal mt-1 font-medium text-zinc-950">{toArabicDigits(selectedCustomer.name)}</p>
              </div>
              <div className="rounded-lg bg-zinc-50 p-4">
